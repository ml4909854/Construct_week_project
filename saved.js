...
setTimeout(function () {
  function section5() {
    ...
    h4.innerHTML = "You have no saved itmes"; // Corrected typo from h2 to h4

    let p2 = document.createElement("p");
    p2.innerHTML = `Sign in to sync your Saved Items <br> across all your devices!`;
    ...
    div2.append(img, h4, p2, p3); // Corrected h2 to h4
    div.append(div2); // Appended div3 to div2
    section_5.append(div);
  }
  section5();
}, 1000);
// Remember to call the function to execute the script
