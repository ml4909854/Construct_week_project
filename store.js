...
// section_4 code ends here

// section_5 code stars here
setTimeout(() => {
  function section5() {
    ...
    h4.innerHTML = "Your bag is empty"; // Corrected typo from h2 to h4
    let p1 = document.createElement("p");
    p1.innerHTML =
      "Items remain in your bag for 60 minutes, and then they're moved to your Saved Items";

    let p2 = document.createElement("p");
    p2.innerHTML = `Sign in to see your bag  <br>  and get shopping!`;

    let p3 = document.createElement("p");
    p3.style.fontSize = "14px";
    p3.innerHTML = "SIGN IN";
    ...
    div2.append(img, h4, p1, p2, p3); // Corrected h2 to h4
    div.append(div2); // Appended div3 to div2
    section_5.append(div);
  }

  section5(); // Remember to call the function to execute the script
}, 1000);
...
window.onload = function () {
  setTimeout(() => {
    if (window.location.pathname.toLowerCase().includes("index.html")) {
      // If current page is index.html, redirect to men.html
      window.location.href = "men.html";
    } else if (window.location.pathname.toLowerCase().includes("men.html")) {
      // If current page is men.html, open a new page (replace "your_new_page.html" with the desired URL)
      window.open("your_new_page.html", "_blank");
    }
  }, 1000);
};
// js code to reach a page of women page
...
// js code tp reach a saved page
let saved_icon = document.getElementById("saved-icon");
